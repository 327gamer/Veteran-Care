...
const configBySlug: Record<string, CategoryDisplayConfig> = {
  ...
  "housing": { icon: Home, color: "text-orange-600", bg: "bg-orange-50", desc: "Emergency shelter, rental help, VA home loans, and housing programs" },
  ...
  "employment": { icon: Briefcase, color: "text-emerald-600", bg: "bg-emerald-50", desc: "Job search, resume help, and career support" },
  "education": { icon: GraduationCap, color: "text-indigo-600", bg: "bg-indigo-50", desc: "GI Bill, trade schools, certifications, and training programs" },
  "transportation": { icon: Car, color: "text-teal-600", bg: "bg-teal-50", desc: "Travel assistance and vehicle grants" },
  "financial": { icon: DollarSign, color: "text-slate-600", bg: "bg-slate-50", desc: "Mortgages, credit repair, lending, and financial coaching" },
  "legal": { icon: Scale, color: "text-slate-600", bg: "bg-slate-50", desc: "Legal aid, disability appeals, and estate planning" },
