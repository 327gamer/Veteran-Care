  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 relative overflow-hidden bg-primary">
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center text-center space-y-8 animate-in fade-in zoom-in duration-700">
        ...
        {/* Logo Section */}
        <div className="mb-8 w-full flex justify-center transform hover:scale-105 transition-transform duration-500">
        ...
        <div className="space-y-4 text-white">
          <h1 className="text-4xl font-heading font-extrabold tracking-tight uppercase drop-shadow-md">
            VeteranCare
          </h1>
        ...
        <div className="w-full space-y-4 pt-4">
          ...
          <Link href="/home">
            <Button variant="outline" className="w-full h-14 text-lg font-bold border-2 border-white text-white hover:bg-white/10 bg-transparent rounded-full transition-all hover:scale-[1.02]">
