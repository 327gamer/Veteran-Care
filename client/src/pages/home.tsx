    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <section className="-mx-4 md:-mx-6 lg:-mx-8 -mt-4 md:-mt-6 lg:-mt-8 py-6 lg:py-12 flex flex-col items-center justify-center text-center space-y-3 mb-4 bg-white">
        ...
        <div className="space-y-2 px-6">
          ...
          <p className="text-muted-foreground text-sm lg:text-base leading-relaxed max-w-sm lg:max-w-lg mx-auto">Veteran Care helps you quickly find benefits, healthcare, housing assistance, employment programs, legal help, discounts on products & services, and other local resources, all in one place.</p>
        </div>
      </section>
      ...
      {/* ── COVERAGE GROWTH — shared with About page ── */}
      <CoverageGrowth className="pt-8 sm:pt-12 pb-4" />
