      ...
      <Card data-testid="card-link-detail">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-3">
            <p className="text-xs text-green-800 mb-2 font-medium">Ambassador Kit — full outreach assets for {link.ambassador_display_name || link.ambassador_name}</p>
            <Button
              size="sm"
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-4xl mx-auto p-4">
        ...
        {filterAmbassador && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4 flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-2 text-sm text-green-800">
              <Package className="w-4 h-4" />
              <span>View <strong>{filterAmbassador}</strong>'s full outreach kit with logo, button, image card, and email assets</span>
            </div>
            <Button
              size="sm"
