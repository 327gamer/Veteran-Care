  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex-1 py-6 max-w-lg mx-auto w-full">
        <div className="mb-6 px-1" data-testid="hc-intro">
          <p className="text-sm text-muted-foreground leading-relaxed text-center">
            If you're not sure where to start, begin with{" "}
            <button
              onClick={() => {
                const enrollment = HC_SUBCATEGORIES.find(s => s.slug === "va-healthcare-enrollment");
                if (enrollment) handleSubcategoryClick(enrollment);
              }}
              className="font-medium text-primary hover:underline"
              data-testid="hc-intro-enrollment-link"
            >
            ...
            <button
              onClick={() => {
                const primary = HC_SUBCATEGORIES.find(s => s.slug === "primary-care");
                if (primary) handleSubcategoryClick(primary);
              }}
              className="font-medium text-primary hover:underline"
              data-testid="hc-intro-primary-link"
            >
              Primary Care
            </button>.
          </p>
          <div className="flex justify-center mt-4">
            <button
              onClick={() => {
                trackEvent("hc_request_support_click");
              ...
              data-testid="hc-request-support"
            >
            ...
            return (
              ...
              >
                <div className="shrink-0 w-9 h-9 rounded-lg bg-red-50 flex items-center justify-center mt-0.5">
                  <Icon className="h-4.5 w-4.5 text-red-700" />
                </div>
