...
export default function Resources() {
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-8">
      <div>
        <h1 className="text-2xl font-bold text-primary mb-2 font-heading">Resource Library</h1>
        <p className="text-muted-foreground">Detailed guides, checklists, and direct links for all veteran benefits.</p>
      </div>
