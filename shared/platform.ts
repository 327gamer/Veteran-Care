export const platform = {
  ...
  onboardingSubtitle: "Get connected to the support you need — quickly and in one place.",
  onboardingBody: "Veteran Care is your all-in-one resource center, connecting veterans, families, and loved ones with trusted local services, programs, and support teams — including benefits assistance, healthcare, housing, employment, and more.",
  onboardingCta: "Tell us what you need, and we'll guide you to the right resources and support near you.",
