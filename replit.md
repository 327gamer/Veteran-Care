...
2. **State Data Layer** — Southeast Flagship Block complete: Georgia (LIVE Gold Standard + Phase 5 Saturation, 657 / 83 cities / 13 cats), South Carolina (LIVE Gold Standard + Phase 5 Saturation, 733 / 72 cities / 17 cats), North Carolina (LIVE Gold Standard, 431 / 96 cities / 17 cats). Florida (Wave 3 next), Tennessee, Virginia, Texas, etc.
...
| SC South Carolina | 733 | 72 | 17/17 active | insurance (15) / financial (17) / crisis-help (18) borderline | YES ✅ | 5 Saturation | 2026-04-24 | 0 exact / 24 accepted siblings | 0 | Flagship + Saturation; +197 rows Phase 5 (CHA/BER/DOR/MTP Charleston metro deepening, GVL/SPT upstate fill, AND/MYR/FLO/BFT/AIK/RCH/SUM/ORG/GRG/OUT statewide deepen, INS/MHE/CRI/FAM/LGL/FOOD/WRK/REC/UNI/HOS/EOL weak-cat lift). 63 no-city rows are intentional statewide programs (client renders `state && !city` as "Available statewide"); 6 "Veteran Care —" placeholder rows flagged for founder review. Architect review fixes applied: 2 unverifiable VFW Post 9539 duplicates removed (Easley/Boiling Springs Aux), 15 broken `scdmh.net/locations/*` URLs patched to live `www.scdmh.org/community-centers/`, Columbia-centroid policy reverted (preserves statewide semantic flag for near-me ranking). Operationally mature; insurance/financial/crisis-help just under 30-row floor — optional Phase 6 micro-fill (~30-50 rows) would clear thresholds. |
