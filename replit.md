...
| NY New York | 158 | 53 | 16/17 active after P3 (transportation 0 dormant — explicit P4 candidate) | transportation 0 / disabled-vets 7 / family 1 / insurance 1 / sub-recovery 5 / education 2 / housing 3 / employment 8 (all queued for P4-P5 saturation) | NO (P1 State Foundation + P2 Healthcare + P3 County/Benefits Backbone shipped 2026-04-27; P4 menu pending founder pick: Transportation / MH-Depth / Upstate Metro / Long Island / Skipped-County browser-UA pass) | Phase 3 County / Benefits Backbone | 2026-04-27 | 0 exact / 0 near-dup | 0 / 0 / 0 | **NY P3 SHIPPED 2026-04-27**: +34 rows / 9 sections (NYC=8 MOVS+HRA+DSS+DFTA+ACCESS HRA+MOPD+Workforce1+CIDNY; Erie=3 VSA+DSS+Senior Services Buffalo; Monroe/Rochester=4 Human Services+OFA+Public Health+RochesterWorks; Onondaga/Syracuse=4 VSA+DSS+Adult&LTC+Health Dept; Nassau=2 DSS+HempsteadWorks; Westchester=4 VSA+DSS+Senior Programs+Westch-Putnam OneStop White Plains+Mount Vernon; Broome/Binghamton=3 VSA+DSS+OFA; Dutchess/Poughkeepsie=2 OFA+OneStop; Statewide=4 NYS DOL Career Centers locator+NY Connects ADRC+ACCES-VR ILC Directory+NYS Workers' Comp Board). 0 dup / 0 near-dup / 0 broken URL / 0 ZIP bleed / 0 bad sub. 5 priority counties SKIPPED wholesale per founder "skip messy fast" rule (no `--allow-broken-urls`): Albany+Suffolk+Rockland+Ulster (entire `*.gov` Cloudflare-403) + Orange (vendor CMS path-redirect bug); their VSO services covered indirectly via NY DVS County VSA Directory row from P1. 2 dry-run fixes: Broome OFA `/seniors`→`/senior` (singular path discovered via homepage scrape) + ACCESS HRA sub `SNAP Application Assistance`→`SNAP Assistance`. P3 cat lifts: financial +12 (16→28), end-of-life +9 (34→43), va-benefits +5, employment +5, healthcare +2, food +1, disabled-vets +1 (6→7). NY locked at P3, awaiting founder approval for P4. See scripts/seed-ny-p3.ts + .local/ny-p3-founder-report.md. |
