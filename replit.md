...
- Pennsylvania rollout: founder selected 2026-04-27 under one-phase-per-run governance lock (stop+report+wait after each phase). **P1 STATE FOUNDATION SHIPPED**: 49 rows / 16 cities / 14/17 cats / 0 dup / 0 near-dup / 0 broken URL / 0 ZIP bleeders. Sections: DMVA core+8 programs, 6 PA Veterans Homes, 6 VAMCs (Pittsburgh/Crescenz-Phila/Coatesville/Wilkes-Barre/Lebanon/Erie), 2 NCA cemeteries (Indiantown Gap/Washington Crossing), 2 helplines (PA 211/PCADV), 8 state agencies (Aging/DHS/DDAP/L&I/CareerLink/Education/Insurance Dept/PHEAA), 7 statewide VSOs (Legion/VFW/AMVETS/VVA Council/DAV Pittsburgh NSO/DAV Phila NSO/PVA Keystone), 7 statewide nonprofits (PA Wounded Warriors/Operation First Response/TAPS-PA/Honor Flight Network/Travis Manion/PHEAA/PA Legal Aid Network), 2 Guard (PANG Family Programs/Fort Indiantown Gap). P1 weak cats (expected at foundation): transportation 0, mental-health 0, housing 0, food/sub/insurance/legal/family 1 each — metro phases P2–P5 will lift. P1 closed; awaiting founder approval for P2. See .local/pa-p1-founder-report.md, scripts/seed-pa-p1.ts.
