...
| NY New York | 184 | 61 | 16/17 active after P1-RESET (transportation 0 dormant) | transportation 0 / disabled-vets 8 / family 1 / insurance 2 / sub-recovery 6 / education 3 / housing 4 / employment 8 | NO (P1 + P2 + P3 + P1-RESET shipped 2026-04-27; awaiting founder pick for P4 Major City Saturation per master-law 6-phase model) | P1 RESET (Clean Rebuild) | 2026-04-27 | 0 exact / 0 near-dup | 0 / 0 / 1 (ESGR intermittent) | **NY P1 RESET SHIPPED 2026-04-27** (post-master-law): +26 rows / 14 sections per founder NEW YORK CLEAN REBUILD DIRECTIVE (additive only, no deletes). L1 vet-specific=9 (AMVETS-NY, VVA-NY, MOPH-NY, JWV-NY, ALA-NY, VFW Aux NY, DMNA, NG Family Programs, ESGR-NY) + L2 mainstream=17 (Salvation Army Empire State, United Way NYS, Goodwill NYNJ, Red Cross GNY/ENY/WNY/SAF, Hunger Solutions NY, Coalition for the Homeless of NYC, DRNY, NYLPI, HESC, NY State of Health, NYSOFA, NAMI NYS, AARP NY, NY Council on Problem Gambling). 26/26 created · 0 dup · 0 near-dup · 0 ZIP bleed · 0 bad sub. 1 broken-URL warning (ESGR State Cmte NY — manually verified 200, engine intermittent network_fail; committed via --allow-broken-urls). 4 dry-run fixes: WWP dropped (already in DB), NYSCADV dropped (already in P1), Feeding NYS dropped (already in P3), Coalition for Homeless renamed to "Coalition for the Homeless of New York City" to break engine fuzzy collision with another state's coalition row. QA: PASS WITH REVIEW (1 missing phone + 1 missing addr both pre-existing P3 statewide-program rows; RESET completeness 26/26 phone+addr). NY locked at 184, STOP+WAIT for P4 pick. See scripts/seed-ny-p1-reset.ts + .local/ny-p1-reset-founder-report.md. |
