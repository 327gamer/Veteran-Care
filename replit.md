...
- Pennsylvania rollout: founder selected 2026-04-27 under one-phase-per-run governance lock (stop+report+wait after each phase). **P1 STATE FOUNDATION SHIPPED**: 49 rows / 16 cities / 14/17 cats / 0 dup / 0 near-dup / 0 broken URL / 0 ZIP bleeders. **P2 HEALTHCARE FOUNDATION SHIPPED 2026-04-27**: +32 rows (10 CBOC across all 6 VAMC parent systems — Allentown/Lancaster/York/Berks-Reading/Cumberland-Mechanicsburg/Williamsport/Sayre/Washington/Beaver/Tobyhanna; 5 Vet Centers — Phila/Pgh/Harrisburg/Erie/Scranton; 6 major hospitals — UPMC Presby/Penn Presby/Geisinger Danville/LVHN Cedar Crest/AGH/Hershey; 4 FQHCs — Project HOME/Squirrel Hill/Family First York/Hamilton Health Harrisburg; 2 NAMI MH; 3 SUD — PRO-ACT/Caron/Gateway; 2 crisis). 0 dup / 0 near-dup / 0 broken URL / 0 ZIP bleeders. 5 broken VA CBOC slugs detected pre-commit and replaced with verified live URLs (lancaster→lancaster-county, berks→berks-county, mechanicsburg→cumberland-county, washington→washington-county; norristown row swapped for verified Tobyhanna VA OPC). **PA cumulative: 81 rows / 30 cities / 15 of 17 cats** (mental-health activated; transportation + homelessness still inactive — queued for P3/P4). P2 weak cats: food/insurance/legal/family-support 1 each, employment 2, va-benefits/education/disabled-vets 3 each. P2 closed; awaiting founder approval for P3 (homelessness + disabled-vets + education depth). See .local/pa-p2-founder-report.md, scripts/seed-pa-p2.ts.
