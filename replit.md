...
- Pennsylvania rollout: founder selected 2026-04-27 under one-phase-per-run governance lock (stop+report+wait after each phase). **P1 STATE FOUNDATION SHIPPED**: 49 rows / 16 cities / 14/17 cats / 0 dup / 0 near-dup / 0 broken URL / 0 ZIP bleeders. **P2 HEALTHCARE FOUNDATION SHIPPED 2026-04-27**: +32 rows (10 CBOC across all 6 VAMC parent systems; 5 Vet Centers; 6 major hospitals; 4 FQHCs; 2 NAMI MH; 3 SUD; 2 crisis). 5 broken VA CBOC slugs replaced pre-commit with verified live URLs. **P3 COUNTY / BENEFITS BACKBONE SHIPPED 2026-04-27**: +38 rows (10 CVSOs — Bucks/Lancaster/Berks/Erie/Westmoreland/York/Lehigh/Luzerne/Centre/Lycoming county veterans affairs offices with verified canonical web pages; 16 PA DHS County Assistance Offices via dhs.pa.gov/contact/Pages/{County}.aspx pattern — Allegheny/Phila/Bucks/Chester/Delaware/Mont/Lancaster/York/Berks/Lehigh/Northampton/Dauphin/Cumberland/Erie/Lackawanna/Luzerne; 9 Area Agencies on Aging — PCA/Bucks/Berks/Westmoreland/Luzerne/Cumberland/AAA Lehigh Valley/COCAA Centre/Lycoming-Clinton; 3 CareerLink regional — Lehigh Valley/Pittsburgh/Berks). 0 dup / 0 near-dup / 0 broken URL / 0 ZIP bleeders. 1 row dropped honestly (Washington County CVSO — washcopa.org 308-redirect engine couldn't follow); no `--allow-broken-urls` bypass used. **PA cumulative: 119 rows / 37 cities / 15 of 17 cats** (transportation + housing/homelessness still inactive — queued for P4/P5). P3 cat lifts: financial 6→22, end-of-life 4→13, va-benefits 3→13, employment 2→5. Remaining weak cats: food/insurance/legal/family-support 1 each, disabled-vets/education 3 each, crisis/substance 4 each. P3 closed; awaiting founder approval for P4 (likely housing/homelessness foundation OR weak-cat lift — founder choice). See .local/pa-p2-founder-report.md, .local/pa-p3-founder-report.md, scripts/seed-pa-p2.ts, scripts/seed-pa-p3.ts.
- Ohio rollout: founder REOPENED 2026-04-27 (NOT complete) — full reset, "no db:push --force, less talking more rows" lock. P1 STATE FOUNDATION (47 rows) + P2 HEALTHCARE (30) + P3 COUNTY BACKBONE (31) + P4 MAJOR CITY SATURATION (44 net of 6 dup/9 near-dup, CLE/CIN/DAY/TOL/AKR/YNG) + P5 WEAK-CAT LIFT (49 net of 9 dup/25 near-dup, financial/disabled-vets/food/transportation/legal/end-of-life/employment/insurance/family-support) all SHIPPED. P6 audit PASS: **OH now 512 rows / 100 cities / 17/17 cats / lowest cat 19 (food-assistance) / 0 missing URL / 0 missing source / 0 dup titles**. **OH LOCKED** until founder reopens. Cat scoreboard: food 19, financial 20, crisis 21, insurance 21, disabled-vets 21, employment 21, legal 21, sub-recovery 22, end-of-life 22, transportation 22, family 26, mental 28, housing 29, education 36, community 41, va-benefits 64, healthcare 78. All P5 URLs verified live (engine pre-commit liveness gate, 0 broken at commit time). 27 missing-phone + 35 missing-addr are legitimately online-only resources (national-HQ orgs, online-only directories). Engine: scripts/lib/rollout-engine.ts UA "VeteranCare-RolloutEngine/1.0 (+url-liveness-gate)". See scripts/seed-oh-rebuild-p1..p5.ts.
