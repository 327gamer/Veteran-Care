...
2. **State Data Layer** — Southeast Flagship Block (GA + SC + NC + FL) complete 2026-04-25, Alabama next. Georgia (LIVE Gold Standard + Phase 5 Saturation + Phase 6 Closeout, 682 / 85 cities / 13 of 17 cats ≥30 floor; weak cats remaining info-only: financial=29, crisis-help=21, disabled-veterans=21, insurance=16), South Carolina (LIVE Gold Standard + Phase 5 Saturation + Phase 6 Closeout, 769 / 72 cities / 17 cats — all 3 weak cats cleared 30+ floor), North Carolina (LIVE Gold Standard + Phase 5 Saturation, 713 / 102 cities / 13 of 17 cats ≥30 floor; weak cats remaining info-only: disabled-veterans=24, food-assistance=28, insurance=25, legal=28), Florida (LIVE Gold Standard / Phase 4 Closeout, 513 / 109 cities / 15 of 17 active cats with ALL 15 active cats over 30 floor — Wave 1 foundation + Wave 2 metro depth + Wave 3 weak-cat closeout/posts/depth + Phase 4 Gold Standard finishing pass with end-of-life lift via We-Honor-Veterans hospices and national cemeteries, family-support lift via military family readiness centers, NAMI/mobile-crisis network, adaptive sports for disabled vets, and metro depth across St. Petersburg, Sarasota, WPB, Naples, Fort Myers, Ocala, Melbourne, Lakeland, Gainesville). Block totals: 2,677 verified veteran state-tagged resources / 368 cities / 4 states (plus ~89 national rows). Alabama, Tennessee, Virginia, Texas, etc.
