...
| NY New York | 204 | 65 | 16/17 active after P2-RESET (transportation 0 dormant) | transportation 0 / disabled-vets 8 / family 1 / insurance 2 / education 3 / housing 4 / employment 8 | NO (P1 + P2 + P3 + P1-RESET + P2-RESET shipped 2026-04-27; awaiting founder pick for P3 County-Benefits next per master-law 6-phase model) | P2 RESET (Healthcare Foundation rebuild) | 2026-04-27 | 0 exact / 0 near-dup | 0 / 0 / 0 broken | **NY P2 RESET SHIPPED 2026-04-27** (additive on top of existing 89 healthcare/MH/crisis/recovery rows): +20 rows / 7 sections. L1 vet-specific=2 (Nassau Vet Center, Westchester Vet Center) + L2 mainstream=18 (4 hospital systems Mount Sinai/Albany Med/Westchester Med/Maimonides + 6 FQHCs Apicha/ODA/Brownsville/Open Door/Evergreen/Floating Hospital + 3 county DOH Rockland/Orange/Dutchess + 2 MH ICL/Vibrant + 1 crisis Crisis Services Erie + 2 recovery Samaritan/Phoenix House). 20/20 created · 0 dup · 0 near-dup · 0 ZIP bleed · 0 bad sub · 0 broken URLs. 10 dropped pre-commit per founder NO-bypass rule: Northwell+Suffolk DOH+Albany Co DOH (WAF), Damian/Jordan (DNS/timeout), MHA-NYC (SSL), Manhattan VC/Plattsburgh VC/Hempstead VC-direct/Rochester VA OPC/Saratoga Springs VA Clinic (no canonical URL resolved). QA: PASS WITH REVIEW (items 5/9 non-blocking pre-existing soft notes). NY now 204 / 65 cities. STOP+WAIT for next phase pick. See scripts/seed-ny-p2-reset.ts + .local/ny-p2-reset-founder-report.md. |
