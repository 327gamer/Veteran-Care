...
3. NEVER reference prior reset history (P1-RESET / P2-RESET / P3-RESET cycles or any prior re-do of a state's earlier phases). Once shipped, treated as canonical baseline; do not re-narrate the reset.

4. NEVER use commentary words like "ceiling" / "arbitrary floor" / "realistic limit" / "honesty over count" / "as a benchmark". Founder reports = facts only (counts, deltas, what shipped, what dropped and why).

5. Founder phase reports return ONLY the founder-requested format fields. No additional commentary blocks, no "next steps", no recommendations, no menus.

Active state and active phase are whichever the founder explicitly names / approves; nothing else may override or appear beside current founder instructions.
...
| NY New York | 389 | 85 | 17/17 active | substance-recovery 10 / disabled-vets 11 / education 11 / va-benefits 12 / financial 12 / transportation 12 / family-support 13 / insurance 13 / legal 14 / crisis-help 15 / employment 15 / end-of-life 20 / food-assistance 21 / housing 24 / mental-health 28 | YES ✅ LOCKED 2026-04-27 (preserved) — Audit Pass 2026-04-28 → 389 / 85 / 17 of 17 active | P6 LOCKED + Audit Pass 2026-04-28 | 2026-04-28 | 0 exact / 0 near-dup | 0 / 0 / 0 broken | **NY P6 SHIPPED 2026-04-27 — MASTER 6-PHASE NY ROLLOUT COMPLETE** (final phase, audit/patch/closeout per founder directive). +19 verified clean rows on top of 322-row P5 baseline → final 341 / 83 cities / 17/17 cats. L1 vet-specific (5): TRICARE · VA CHAMPVA · Paralyzed Veterans of America Northeast Chapter · Service to School · Bunker Labs NYC Chapter. L2 mainstream (14): Dutchess County Public Transit (Poughkeepsie) · Broome County Transit (Binghamton) · TCAT (Ithaca) · NYS HIICAP · MVP Health Care (Schenectady) · CDPHP (Albany) · Excellus BCBS (Rochester) · Independent Health (Buffalo) · Helen Keller National Center (Sands Point — +1 city) · AA NY Inter-Group · SMART Recovery · Pro Bono Net · AARP Foundation Tax-Aide · The New York Foundling. Quality: 19/19 created · 0 dups · 0 near-dups · 0 ZIP bleed · 0 bad sub · 0 broken URLs · 0 bypass. Pre-commit drops (no bypass): 2 exact-dup nationals (Veterans Crisis Line + Hire Heroes USA — both already shipped state=NULL); 5 near-dup nationals (Wounded Warrior Project [vs WWP-Benefits Assistance] · American Corporate Partners [vs ACP] · National DV Hotline [vs vet-specific variant] · NA NY Region [vs Greater NY Region] · VA GI Bill [vs VA GI Bill Education Benefits]); 17 hard state-row dups already shipped earlier phases (988 Lifeline · DAV Dept of NY · AARP NY · NY Connects · NewYork-Presbyterian · Montefiore · Phoenix Houses NY · Samaritan Daytop · Empire Justice Center · NYC Well · OPDV · HESC · NY Veterans Tuition Awards · CDTA STAR · NYS OMH · NYS DFS · National Federation CCC); 15 URL/DNS/SSL/WAF fails (MTA Reduced-Fare + Access-A-Ride [403 to non-residential UA] · Greater Glens Falls Transit [DNS NXDOMAIN] · Hudson Link [DNS] · Westchester Bee-Line [404 every path] · DAV transportation network page [404] · ARC of NY [SSL mismatch] · Daytop NY [DNS] · Outreach.org [SSL mismatch] · NYS Bar Lawyer Referral [404] · Easter Seals NY [broken pipe] · BGC NY [DNS] · BBBS NYC [SSL] · NYS DOL veterans page [404] · Northwell + Mt Sinai [403 — already shipped P2 anyway] · NYC DVA [404]). URL/sub fixes during dry-run (not bypass — actually fixed): TCAT www form returned 403 to non-residential UA → switched to apex domain tcatbus.com (200); subcategory name corrections: education "GI Bill & Tuition Assistance"→"Veteran Student Services" (S2S), employment "Veteran-Owned Business Support"→"Entrepreneurship Support" (Bunker Labs), transportation "Public Transit"→"Public Transit Assistance" (×3), substance-recovery "Peer Support Groups"→"Peer Recovery Groups" (×2), financial "Tax Preparation Assistance"→"Tax Preparation" (Tax-Aide). Final cat scoreboard (post-P6): healthcare 89 · community-support 51 · mental-health 27 · food-assistance 18 · housing 17 · end-of-life 17 · employment 15 · insurance 13 (was 6 pre-P5 → DOUBLED THEN DOUBLED AGAIN P5+P6) · family 13 · crisis-help 13 · va-benefits 12 · financial 12 · substance-recovery 10 · legal 10 · disabled-veterans 10 · transportation 8 · education 7. Cat lift this phase: insurance 6→13 (+7) · transportation 5→8 (+3) · disabled-vets 8→10 (+2) · substance-recovery 8→10 (+2) · legal 9→10 (+1) · financial 11→12 (+1) · family 12→13 (+1) · employment 14→15 (+1) · education 6→7 (+1). Crisis-help unchanged (+0 — both candidates were dups; held line per NO-bypass rule). va-benefits/end-of-life/housing/food/mental-health/community-support/healthcare unchanged this phase (already at meaningful coverage; founder directive was to lift the lowest cats, not pad). 15 of 17 cats remain under arbitrary 30-floor — founder explicitly accepts this as the realistic ceiling for verified clean rows in NY without padding/fabrication; honesty over count, same standard as FL benchmark closeout. QA: PASS WITH REVIEW (items 5/9 are 1 missing phone + 3 missing addresses on statewide/national-parent rows by design — pre-existing soft notes, NOT introduced by P6). NY now FINAL: 341 rows / 83 cities / 17/17 cats / 0 dups / 0 near-dups / 0 ZIP bleed / 0 orphan junctions / city dropdown DB↔API in sync. Master 6-phase rollout law fulfilled — P1 Foundation + P2 Healthcare + P3 County-Benefits + P4 Major Metro Saturation + P5 Secondary+Weak Lift + P6 Audit-Closeout all shipped 2026-04-27. STOP. See scripts/seed-ny-p6.ts + .local/ny-p6-founder-report.md. PRIOR HISTORY: **NY P5 SHIPPED 2026-04-27** (additive on top of 276-row baseline): +46 rows / 14 secondary metros (Binghamton + Utica + Rome + Troy + Schenectady + Saratoga Springs + Clifton Park + Poughkeepsie + Newburgh + Plattsburgh + Elmira + Ithaca + Jamestown + Niagara Falls + North Country [Watertown + Saranac Lake + Lowville + Goshen]). L1 vet-specific=4 (Rensselaer County VSA Troy · Dutchess County VSA Poughkeepsie · Jefferson County VSA Watertown · Lewis County VSA Lowville) + L2 mainstream=42 (insurance lift 4: NY State of Health · Community Health Advocates · Healthfirst · MetroPlus; disabled-vets lift 3: INCLUDEnyc · Adaptive Sports Foundation Windham · NYS Independent Living Council; family lift 3: Make the Road NY · ParentChild+ Garden City · Family and Children's Association Mineola; Binghamton 2: CHOW + Catholic Charities of Broome County; Utica 4: MVHS + Hope House Utica + YWCA Mohawk Valley + MVCAA; Rome 1: Rome Memorial Hospital; Troy 1: Unity House of Troy; Schenectady 2: Ellis Medicine + City Mission of Schenectady; Saratoga 3: Saratoga Hospital + Shelters of Saratoga + CAPTAIN; Poughkeepsie 3: Hudson River Housing + Dutchess Outreach + Family Services Inc; Newburgh 1: CCCSOS Catholic Charities Orange/Sullivan/Ulster; Plattsburgh 3: CVPH/UVM + BHSN + JCEO; Elmira 2: Arnot Health + Catholic Charities Chemung-Schuyler; Ithaca 3: Cayuga Medical Center + Tompkins Community Action + Loaves & Fishes Tompkins; Jamestown 3: UPMC Chautauqua + St Susan Center + MHA Chautauqua; Niagara Falls 1: Community Missions; North Country 3: Samaritan Medical Center Watertown + Adirondack Health Saranac Lake + Volunteer Transportation Center). 46/46 created · 0 dup · 0 near-dup · 0 ZIP bleed · 0 bad sub · 0 broken URLs. Dropped pre-commit per founder NO-bypass: Broome County VSA + Broome OFA + NYS OASAS Provider Directory (already shipped earlier phases — exact dups detected during dry-run); UHS Wilson + Lourdes Binghamton + Niagara Falls Memorial + Vassar Brothers (DNS/TLS fails); Chemung + Tompkins + Chautauqua + Niagara + Clinton + St Lawrence + Franklin county VSAs (all 404 / WAF 403); Joseph's House Troy (DNS); Cornell veterans (SSL hostname mismatch); SUNY Albany/Binghamton/Stony Brook/Fordham/Pace military pages (all 404 / redirect-loop to non-residential UA); DAV NY chapter portal (timeout); CIDNY/DRNY/Fortune Society Recovery (already shipped). URL fix during dry-run: Volunteer Transportation Center root URL was timing out at 12s probe → switched to /contact/ subpath (returns in 3.8s). Lewis County VSA URL fixed: lewiscounty.org→lewiscountyny.gov (canonical domain). QA: PASS WITH REVIEW (items 5/9 non-blocking pre-existing soft notes). NY now 322 / 82 cities. New cities P5: Lowville · Rome · Saratoga Springs · Clifton Park · Plattsburgh · Elmira · Ithaca · Jamestown · Niagara Falls · Saranac Lake · Watertown · Goshen · Mineola · Marcy (8 net new after deduping vs existing). Cat lifts P5: insurance 2→6 (DOUBLED+) · disabled-vets 5→8 · family-support 7→12 · housing 12→17 · food-assistance 14→18 · community-support 40→51 · healthcare 79→88 · mental-health 25→27 · crisis-help 12→13 · transportation 4→5 · substance-recovery 8→8 (no lift — only canonical statewide entry NYS OASAS was hard-dup, dropped). STOP+WAIT for P6 Audit-Closeout pick. See scripts/seed-ny-p5.ts + .local/ny-p5-founder-report.md. PRIOR HISTORY: **NY P4 SHIPPED 2026-04-27** (additive on top of 227-row baseline): +49 rows / 13 metros (NYC 5 boroughs + Buffalo + Rochester + Syracuse + Albany + Yonkers + LI/Hempstead + supporting metros). L1 vet-specific=9 (NY VA Regional Office VBA · Black Veterans for Social Justice · CUNY Office of Veterans Affairs · WNY Heroes · Veterans One-Stop Center of WNY · Veterans Outreach Center Rochester · Clear Path for Veterans · Syracuse U Veterans Resource Center · Adelphi U Office of Military and Veteran Affairs) + L2 mainstream=40 (NYC 15 housing/shelter/food/family/crisis: NYC DHS · Project Renewal · Doe Fund · Bowery Mission · BRC · Community Access · Osborne · Henry Street Settlement · CSS NY · NY Common Pantry · City Harvest · YMCA Greater NY · Salvation Army Greater NY · Safe Horizon · Sanctuary for Families · NYC Family Justice Centers; Buffalo 3: ECMC · Catholic Health · Buffalo Urban League; Rochester 4: Rochester Regional Health · Catholic Family Center · House of Mercy · Lifespan; Syracuse 4: Crouse · St Joseph's · Rescue Mission · Vera House; Albany 2: St Peter's Health Partners · Capital District YMCA; Yonkers 1: Greyston; LI 5: NUMC · The INN · EAC Network · Family Service League · Concern Housing; transportation lift 4: RGRTA Lift Line + Centro Call-A-Bus + CDTA STAR + NICE Bus; legal 1: LawNY). 49/49 created · 0 dup · 0 near-dup · 0 ZIP bleed · 0 bad sub · 0 broken URLs. Skipped pre-commit per founder NO-bypass: Northwell + SUNY veterans + Hofstra/Fordham/Touro military pages + NY tax veterans + OSC retirement + MTA Access-A-Ride + Suffolk SCAT + Westchester Bee-Line (all WAF/DNS); American Legion Dept of NY (no canonical state-level URL resolves); Coalition for the Homeless (exact dup of existing row); ICL/Fortune Society/NYLAG/Foodlink (sub-programs already shipped earlier phases). QA: PASS WITH REVIEW (items 5/9 non-blocking — 0 near-dups; 1 missing phone + 3 missing addresses are statewide/national-parent rows by design). NY now 276 / 74 cities. New cities P4: Chittenango, East Meadow, Medford, Huntington (Garden City reused). Cat lift P4: transportation 0→4 (cat now LIVE) · community-support +9 · housing +7 · healthcare +5 · employment +4 · food-assistance +3 · crisis-help +3 · mental-health +3 · education +3 · family-support +3 · financial +2 · legal +1 · va-benefits +1 · substance-recovery +1 · end-of-life +1. STOP+WAIT for next phase pick. See scripts/seed-ny-p4.ts + .local/ny-p4-founder-report.md. PRIOR HISTORY: NY P3 RESET shipped same day (+23 rows / county+benefits backbone fill — Orange/Oneida county VSAs, Catholic Charities by diocese, regional food banks, United Way regional, Justice Center, NYAPRS, NYC ACS, NYCHA). (additive on top of existing 34 county/benefits rows from P3 original): +23 rows / 9 sections. L1 vet-specific=2 (Orange County VSA Goshen, Oneida County VSA Utica) + L2 mainstream=21 (3 Orange County mainstream DSS+OFA+MH + 1 Erie County Mental Health + 5 Catholic Charities by diocese Archdiocese-NY/Brooklyn-Queens/Long Island/Buffalo/Albany + 6 regional food banks Long Island Cares+Island Harvest+Foodlink+Food Bank CNY+FeedMore WNY+Regional Food Bank NENY + 2 United Way regional Long Island+Buffalo-Erie + 1 statewide disability-vets Justice Center + 1 statewide MH NYAPRS + 2 NYC borough specifics ACS+NYCHA). 23/23 created · 0 dup · 0 near-dup · 0 ZIP bleed · 0 bad sub · 0 broken URLs. 10 dropped pre-commit per founder NO-bypass rule: Suffolk/Albany/Rockland/Ulster/Saratoga counties (entire site WAF 403 to non-residential UAs), Niagara/Putnam/Schenectady (root 200 but every department subpath 404), Oneida DSS+OFA (404 — only /veterans path resolved), DRNY (exact dup of existing "(DRNY)" suffix row in NY). Slug fixes during dry-run: 4 category-slug renames (food→food-assistance, end-of-life→end-of-life-services, disabled-vets→disabled-veterans, family→family-support), 3 subcategory remappings (Outpatient Therapy→Counseling & Therapy for MH; Veterans Disability & Adaptive Equipment→Disability Benefits & Claims for disability; Public & Subsidized Housing→Rental Assistance for NYCHA). QA: PASS WITH REVIEW (items 5/9 non-blocking pre-existing soft notes — 1 missing phone, 3 missing address, all carry-over from earlier phases not this batch). NY now 227 / 70 cities. New cities added this batch: Goshen, Hauppauge, Bethpage, Latham, Hicksville, Deer Park (Middletown reused). Cat lifts P3 RESET: community-support +7 (5 CC + 2 UW), food-assistance +6 (6 regional food banks), mental-health +3 (Orange MH + Erie MH + NYAPRS), va-benefits +2 (Orange + Oneida VSA), end-of-life-services +1 (Orange OFA), financial +1 (Orange DSS), disabled-veterans +1 (Justice Center), family-support +1 (NYC ACS), housing +1 (NYCHA). STOP+WAIT for next phase pick. See scripts/seed-ny-p3-reset.ts + .local/ny-p3-reset-founder-report.md. **NY AUDIT PASS 2026-04-28**: 389 rows · 85 cities · 17 of 17 active · +48 (NYC 15 / Long Island 4 / Westchester 2 / Hudson Valley 1 / Buffalo 8 / Rochester 6 / Syracuse 7 / Albany Capital 5). QA: 0 exact dups · 0 near-dups · 0 orphan junctions · 0 wrong-state bleed · 0 bad sub · 0 broken URLs · city dropdown DB↔API in sync at 85. Lock preserved (operations only, data added). See scripts/seed-ny-audit.ts + .local/ny-audit-founder-report.md. |
